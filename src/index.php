<?php
	...
	define("CDN_URL", "http://cdn.markuslerner.com/travelscope/"); // http://cdn.markuslerner.com/travelscope/
	...
	$latest_visa_requirements_filename = $visa_requirements_folder . "/" . $latest_filename;
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  	...
  	<meta property="og:image" content="http://cdn.markuslerner.com/wordpress/wp-content/uploads/2016/04/travelscope_4k_1_cropped-640x400@2x.png" />
    ...
    <link rel="stylesheet" type="text/css" href="<?=CDN_URL?>assets/fonts/fonts.css">

    <link rel="stylesheet" type="text/css" href="<?=CDN_URL?>css/main.css" />
  ...
  <div id="container"></div>
	...
	<button type="button" id="button_country_list" class="btn btn-default btn-sm" title="Toggle country list">Country list<span class="caret"></span></button>
		...
		<div class="inside">
			<div class="details">
				<div class="section">
					...
					<p>
					In order to display the visa regulations for a certain nationality, the source country can be intuitively selected by clicking/tapping the map, via the live search field or by choosing it from the country list. In the <i>Visa-free sources</i> mode, you can alternatively explore the number of countries whose nationals can enter a specific country without a visa or with visa on arrival. The <i>GDP</i> and <i>population</i> modes are added for reference. Other modes can be implemented in the future.
					</p>
					<p>
  ...
  <a href="https://github.com/asutherland/d3-threeD" target="_blank">d3.js hooked up to three.js</a>,
	...
	<a href="https://github.com/sole/tween.js/" target="_blank">tween.js</a>,
